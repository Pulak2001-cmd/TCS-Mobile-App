...
Future<List<FlSpot>> populatePastPredictionsLineChartData({required List<Map<String, double>> avgTemperatureByHoursMaps, int noOfDigitsAfterDecimal = 1, required String parameter, PotatoData? potatoData}) async {
...
Future<List<List<FlSpot>>> getJSON(DatabaseReference dataRef, String parameter, {int noOfDigitsAfterDecimal = 1}) async{
  ...
  pastPredictionsLineChartData = await populatePastPredictionsLineChartData(avgTemperatureByHoursMaps: calculateAvgTemperatureAndHumidityByHours(sensorData, hours: 6), parameter: parameter, noOfDigitsAfterDecimal: noOfDigitsAfterDecimal);
