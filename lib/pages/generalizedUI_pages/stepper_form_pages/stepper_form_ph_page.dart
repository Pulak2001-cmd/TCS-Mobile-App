...
class StepperFormPhPage extends StatefulWidget {
  String selectedParameter;
  StepperFormPhPage({Key? key, required this.selectedParameter}) : super(key: key);

  @override
  State<StepperFormPhPage> createState() => _StepperFormPhPageState();
}

class _StepperFormPhPageState extends State<StepperFormPhPage> {
          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                title: Text(
                  'Change in pH at a particular T and RH',
                  style: TextStyle(
                    color: Colors.white70,
                  ),
                ),
