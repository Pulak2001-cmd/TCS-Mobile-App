...
class StepperFormChipsColorPage extends StatefulWidget {
  String selectedParameter;
  StepperFormChipsColorPage({Key? key, required this.selectedParameter}) : super(key: key);

  @override
  State<StepperFormChipsColorPage> createState() => _StepperFormChipsColorPageState();
}

class _StepperFormChipsColorPageState extends State<StepperFormChipsColorPage> {
