...
class QualityOfLotsScreenHardcoded extends StatefulWidget {
  ...
  @override
  State<QualityOfLotsScreenHardcoded> createState() => _QualityOfLotsScreenHardcodedState();
}

class _QualityOfLotsScreenHardcodedState extends State<QualityOfLotsScreenHardcoded> {
  List<CropStatus> cropStatusList = [
    CropStatus(
      image: 'https://firebasestorage.googleapis.com/v0/b/tcs-app-affde.appspot.com/o/test%2F1.jpg?alt=media&token=689bf272-1689-4244-b332-9ca063c08064',
    ...
    CropStatus(
        image: 'https://firebasestorage.googleapis.com/v0/b/tcs-app-affde.appspot.com/o/test%2F2.jpg?alt=media&token=c2a2d3a4-a05a-4114-b7b9-3ecaf553bd20',
        sproutStatus: 'Not Sprouted',
        diseaseStatus: 'Not Diseased',
        weightLossStatus: 'Weight loss < 10%',
        overallHealthStatus: 'Healthy'
    ...
    Future.delayed(Duration(seconds: 1),(){
      setState((){
        cropStatusList = [
          ...
          CropStatus(
              image: 'https://firebasestorage.googleapis.com/v0/b/tcs-app-affde.appspot.com/o/test%2Fspouted-refrigerator2.jpg?alt=media&token=ec81e02e-27b3-4bb5-bd30-1d1cd220e133',
      ...
      Provider.of<UselessProvider>(context, listen: false).setIsLotsHealthy(false);
    });
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  leading: CircleAvatar(
                                    backgroundImage: NetworkImage(cropStatusList[index].image!),
                                  ),
                                  title: Text(
                                    'Potato (Cam ${index + 1})',
                                    style:TextStyle(
                                  ...
                                  onTap: ()=> showModalBottomSheet(
                                    ...
                                    context: context,
                                    builder: (context) => buildSheetQualityOfLots(context, cropStatusList[index], NetworkImage(cropStatusList[index].image!)),
                                    backgroundColor: Colors.transparent,
                                  ),
                                ),
                              );
