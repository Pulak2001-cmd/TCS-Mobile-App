...
class _ReducingSugarLineChartWidgetState extends State<ReducingSugarLineChartWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: getData(parameter: 'Reducing Sugar', noOfDigitsAfterDecimal: 5),
      // stream: getData(),
  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
    return Text(getAxisLabel(value: value, maxAxisLabel: maxAxisLabel, minAxisLabel: minAxisLabel, flattenedData: flattenedData, symbol: '', digitsAfterDecimal: 3), style: getStyle(), textAlign: TextAlign.center);
  }
