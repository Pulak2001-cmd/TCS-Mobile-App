...
class DashboardDataTextFields extends StatefulWidget {
  ...
  const DashboardDataTextFields(
      {Key? key,
      required this.index,
      required this.refreshVariety,
      required this.refreshVarietyType})
      : super(key: key);

  @override
  State<DashboardDataTextFields> createState() =>
      _DashboardDataTextFieldsState();
}
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide:
                        BorderSide(color: Color(0xFFFFFFFF), width: 5.0),
                  ),
                ),
